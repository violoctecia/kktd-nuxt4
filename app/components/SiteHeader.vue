<template>
	<header class="sticky top-0 z-50 bg-primaryDark text-background">
		<div class="container flex items-center justify-between gap-4 py-4">
			<nuxt-link to="/" class="logo flex items-start gap-4">
				<div class="flex" @click="isMenuToggled = false">
					<nuxt-img
						priority
				...
				<div class="hidden flex-col lg:flex">
					<p class="text-sm font-bold leading-4">Казанский Колледж Технологии и Дизайна</p>
					<p class="text-xs">Профессиональное образование в сфере IT и мануфактуры</p>
				</div>
			</nuxt-link>
...
const navItems = [
	...
	{ label: 'Поступающему', href: '/abiturient' },
