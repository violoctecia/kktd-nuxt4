<template>
	<h3 class="text-2xl">Редактирование новости {{ item.id }}</h3>
	...
	<form @submit="send">
		...
		<div class="input-group">
			...
			<input class="input" id="file" type="file" :required="!formData.imgPreview" accept="image/*" @change="handleFileChange" />
